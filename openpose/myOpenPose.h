...
public:
    ...
    void DetectTargetPerson(std::vector<OpenPosePerson>& personList, cv::Mat image, bool USING_PROB=true, std::string INIT_POINT_FILE="");
    ...
    void tracking(OpenPosePerson& prevPerson, std::vector<OpenPosePerson>& personList);
};
